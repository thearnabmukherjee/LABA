...
<div class="container-fluid p-3" style="max-width:1500px">
  ...
  <p class="text font-weight-bold " style="margin:0;font-size:2rem">Your Orders</p>
  </div>  
<%
 int t=0;
 int total=0;
 ...
 try
 {
	if(session.getAttribute("email")==null)
 	{
 	response.sendRedirect("login.jsp?link=order");
 	}
 else
 {
	...
	ResultSet rs=stm.executeQuery("select * from books inner join cart on books.id=cart.pr_id and cart.email='"+email+"' and cart.orderdate is not null ORDER BY cart.orderdate DESC");
	while(rs.next())
	{
		sno=sno+1;
		t=1;
...
<div class="container border rounded  mb-2 mt-4"  style="border-color:#cccccc;">
	      ...
	      <img src="/Laba/Pictures/booksPic/<%=rs.getString(6)%>" class="img-fluid" alt="..." style="max-width:200px; max-height:200px;object-fit:contain;">
	       ...
	       <div class="col text-center text-md-left text-lg-left  mt-3 mt-md-0 mt-lg-0 col-lg-5 col-md-5 col-12  ">
	        ...
	        <div class="col text-center text-md-left text-lg-left  mt-1 mt-md-0 mt-lg-0 col-lg-4 col-md-4 col-12 border-md-top  ">
				...
				<div class="row mx-auto justify-content-center align-item-center mb-2 " style="max-width:150px" >
				<div class="row">
			...
			<div class="col col-lg-12 col-md-12 col-12 justify-content-center">
			<a class=" btn btn-outline-danger text-red" href="cancelorder?cart_id=<%=rs.getInt(19) %>" style="width:70%;" >Cancel Order</a> 
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header " style="background-color: #131313;">
        <h5 class="modal-title text-light" id="exampleModalLabel">Cancel Order</h5>
      ...
      <div class="modal-body">
        ...
        <form>
        <input type="text" class="form-control" name="cart_id" value="<%=rs.getInt(19) %>">
        </form>
      </div>
...
<a href="BooksIndex.jsp" class=" btn btn1 text-light">Add to cart</a>
</div>
<%}
