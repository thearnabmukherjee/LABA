  ...
  try
  {
  	...
  	if(rs.next())
  	{
  		...
  		<p class="text font-weight-bold" style="margin:0 ;font-size:30px" ><%=rs.getString(2) %></p>
	       ...
	       <div class="row ">
  			<div class="col-12 col-md-6 col-lg-6 m-0"><a class="btn brt" data-toggle="modal" data-target="#issuebook">Issue Book</a></div>
  			<div class="col-12 col-md-6 col-lg-6 m-0"> <a class="btn btn-outline-danger byt"  data-toggle="modal" data-target="#cancelorder">Cancel Order</a> </div>
  		</div>
      ...
      <p class="text" style="margin:0;margin-bottom:1rem;font-size:20px" ><b>Book Name:</b> <%=b_name %></p>
        ...
        <p class="text" style="margin:0;margin-bottom:1rem;font-size:20px" ><b>Order date :</b> <%=o_date %></p>
         <p class="text" style="margin:0;margin-bottom:1rem;font-size:20px" ><b>Issue date :</b> <%=i_date %></p>
             <p class="text" style="margin:0;margin-bottom:1rem;font-size:20px" ><b>Current Status :</b><font color="#00bf86"> Placed</font></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a type="button" class="btn btn-r text-light" href="/Laba/IssueBook?cart_id=<%=cart_id%>">Issue Book</a>
      </div>
    </div>
  </div>
</div>
