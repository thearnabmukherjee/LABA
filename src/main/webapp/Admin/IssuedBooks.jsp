...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css" integrity="sha384-B0vP5xmATw1+K9KRQjQERJvTumQW0nPEzvF6L/Z6nronJ3oUOFUFpCjEUQouq2+l" crossorigin="anonymous">
     ...
     <title>Issued Orders | Laba</title>
  ...
  <p class="text font-weight-bold " style="margin:0;font-size:2rem">Issued Orders</p>
  </div> 
...
<div class="row mx-auto justify-content-center align-items-center text-center container  ">
    ...
    try
    {
    	...
    	ResultSet rs=stm.executeQuery("select * from books inner join cart on books.id=cart.pr_id and cart.status='Issued' and cart.pickupdate is not null ORDER BY cart.pickupdate DESC ");
	...
	<div class="row py-3">
	      ...
	      <img src="/Laba/Pictures/booksPic/<%=rs.getString(6)%>" class="img-fluid" alt="..." style="max-width:200px; max-height:200px;object-fit:contain;">
	       ...
	       <div class="col col-lg-12 col-md-12 col-12"> <p class="text" style="margin:0;font-size:18px" ><b>Email :</b><%=rs.getString(8) %></p></div>
			...
			<a href="ReturnOrder.jsp?cart_id=<%=rs.getInt(19)%>" class=" btn byt">Return Book</a>
			</div>
			</div>	
