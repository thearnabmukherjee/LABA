...
<div class="row mx-auto justify-content-center align-items-center text-center container  ">
    ...
    try
    {
    	...
    	ResultSet rs=stm.executeQuery("select * from books inner join cart on books.id=cart.pr_id and cart.status='placed' and cart.orderdate is not null ORDER BY cart.cart_id DESC ");
