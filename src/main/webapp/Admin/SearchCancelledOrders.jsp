...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <p class="text font-weight-bold " style="margin:0;font-size:2rem">Cancelled Orders</p>
  </div> 
    
    <form class="form" action="SearchCancelledOrders.jsp" method="POST">
<div class="row mx-auto justify-content-center align-items-center text-center container  ">
    ...
    try
    {
    	...
    	ResultSet rs=stm.executeQuery("select * from books inner join cart on books.id=cart.pr_id and cart.status='Cancelled' where pr_name like '%"+ser+"%' or pr_des like '%"+ser+"%'or pr_author like '%"+ser+"%' or email like '%"+ser+"%' and cart.cancelleddate is not null ORDER BY cart.cart_id DESC ");
	...
	<div class="row py-3">
	      ...
	      <img src="/Laba/Pictures/booksPic/<%=rs.getString(6)%>" class="img-fluid" alt="..." style="max-width:200px; max-height:200px;object-fit:contain;">
	       ...
	       <div class="col col-lg-12 col-md-12 col-12"> <p class="text" style="margin:0;font-size:18px" ><b>Email :</b><%=rs.getString(8) %></p></div>
	        ...
	        <div class="col col-lg-6 col-md-6 col-6"> <p class=" text" style="margin:0;color:#ff0000;font-size:20px"><%=rs.getString(15) %></p></div>
	        </div>
