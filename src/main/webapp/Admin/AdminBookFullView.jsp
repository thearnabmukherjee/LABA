  ...
  try
  {
  	...
  	if(rs.next())
  	{
  		...
  		<p class="text font-weight-bold" style="margin:0 ;font-size:30px" ><%=rs.getString(2) %></p>
	        ...
	        <div class="row ">
  			<div class="col m-0"> <p class="text" style="margin:0;margin-bottom:0.9rem;font-size:20px" ><b>Price :</b><i class="fa fa-rupee" style="font-size:15px"></i><%=rs.getString(3) %>  </i></a></p></div>
  		</div>
	       ...
	       <div class="row ">
  			...
  			<div class="col-12 col-md-12 col-lg-12 m-0"><a class="btn brt" href="EditBook.jsp?pr_id=<%=rs.getInt(1) %>">Edit Book</a></div>
