...
String ss="select * from books where id='"+id+"'";
...
%>
  ...
  <form method="post" action="/Laba/AdminEditBooks" id="frs" enctype='multipart/form-data'>
  <div class="row px-3">
    ...
    <div class="drop-zone" >
       ...
       <div class="drop-zone__thumb" data-label="<%=rs.getString(6) %>" style="background-image:url("./Laba/Pictures/booksPic/<%=rs.getString(6) %>");></div>
       <%}
       %>
...
<div class="col col-lg-7 col-md-7 col-12">
    ...
    <div class="row">
      <div class="col">
      <input type="hidden" name="pr_id" value="<%=rs.getString(1)%>">
        <input type="text"  class="form-control mt-4" placeholder="Book Name" name="pr_name" value="<%=rs.getString(2)%>">
      	   </div>
      
      <div class="col">
        <input type="text" class="form-control mt-4" placeholder="Author" name="pr_author"  value="<%=rs.getString(7)%>">
      </div>
       <input type="text" class="form-control mt-4 ml-3 mr-3" placeholder="Price" name="pr_price"  value="<%=rs.getString(3)%>">
      <textarea class="form-control mt-4 ml-3 mr-3" id="exampleFormControlTextarea1" rows="3" placeholder="Description" name="pr_des"  ><%=rs.getString(4)%></textarea>
