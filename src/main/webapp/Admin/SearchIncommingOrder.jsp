...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <p class="text font-weight-bold " style="margin:0;font-size:2rem">Incoming Orders</p>
    ...
    <form class="form" action="SearchIncommingOrder.jsp" method="POST">
<div class="row mx-auto justify-content-center align-items-center text-center container  ">
    ...
    try
    {
    	...
    	ResultSet rs=stm.executeQuery("select * from books inner join cart on books.id=cart.pr_id and cart.status='placed' where pr_name like '%"+ser+"%' or pr_des like '%"+ser+"%'or pr_author like '%"+ser+"%' or email like '%"+ser+"%' and cart.orderdate is not null ORDER BY cart.cart_id DESC ");
