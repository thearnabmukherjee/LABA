...
<link rel="stylesheet" href="/Laba/style/adminstyle.css" type="text/css">
  ...
  <body>
     ...
     {
    	 AdminUser user=(AdminUser)session.getAttribute("aduser");
    	 int id=user.getId();
    	 rr=AdminDbQuery.getDatabyId(id);
        ...
        <div class="profile row">
            ...
            <div class="col-12 col-md-7 col-lg-7">
                <div class="proContent">
                    ...
                    <input type="text" class="form-control" placeholder="City"value="<%=rr.getLocation() %>" disabled>
                    <div class="proBtn">            
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  method="post" action="/Laba/AdminUpdateProfile" id="frs" enctype="multipart/form-data">
      ...
      <input type="file" class="form-control-file" name="pro_pic">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="city" name="city"><%=rr.getLocation() %></textarea>
          </div>
